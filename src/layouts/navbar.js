        ...
        <div className="fr h-100 dt pa2">
          <div className="dtc v-mid">
            <a className="b--light-gray bg-animate hover-bg-gray" href="https://www.mixcloud.com/Funky_Fresh/" title="Mixcloud" target="_blank">
              <svg className="dib h2 w2-l w2-m w1" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fillRule="evenodd" clipRule="evenodd" strokeLinejoin="round" strokeMiterlimit="1.414">
                <g fillRule="nonzero">
