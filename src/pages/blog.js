...
export default function Template({ data }) {
  ...
  return(
    <div className="bg-light-gray pa5-ns bt helvetica w-100 pa3">
      <Helmet title={`Funky Fresh | Blog`} />
      <section className="pa3 pt4 mw7 center avenir">
        <h2 className="helvetica fw1 ph3 pt4 ph0-l">Blog</h2>
          ...
          return (
            <article key={post.id} className="content pa2 bt bb b--black-10">
              ...
              <div className="flex flex-column flex-row-ns">
                ...
                <h1 className="f3 fw1 helvetica mt0 lh-title">{post.frontmatter.title}</h1>
